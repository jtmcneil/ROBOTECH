Occupations = {
    ...
    VeritechPilot: {
        name: "Veritech Pilot",
        description: `The Veritech Fighter pilot is still the very elite of the Robotech Defense Force (RDF) and the Robotech Expeditionary Force (REF). The smaller and more agile Alpha and Beta Fighters make these mecha pilots deadlier than ever.
    ...
    CommunicationsEngineer: {
        ...
        description: `The communications engineer is the high-tech wizard who can link an entire world with sight and sound. This character has an in-depth knowledge of state-of-the-art communication systems, including satellite relays, laser transmissions, video telecasts, and surveillance. It is his or her job to establish and maintain communications on the battlefield and into space. The character can be a vital link to survival whether he/she is a field operator, a member of a reconnaissance team, or a deck officer on the bridge of a spaceship.
        ...
        reqOccSkills:[
            ...
            { skill: "Radio: Scramblers", buff: 15 },
...
module.exports = [
    ...
    Occupations.CommunicationsEngineer,
