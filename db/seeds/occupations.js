Occupations = {
    ...
    CommunicationsEngineer: {
        ...
        reqOccSkills:[
            ...
            { skill: "Hand to Hand Combat: Basic", buff: 0 }  // Assuming buff is not specified for this skill
          ]
          ,
        choiceOccSkills:[
            {
    ...
    FieldScientist: { 
        ...
        reqOccSkills:[
            ...
            { skill: "Paramedic", buff: 10 },  // Assuming buff is not specified for this skill
