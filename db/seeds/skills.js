module.exports = [
    ...
    },
    {
        ...
        description: "Study and understanding of the operation, methods, and techniques involved in the use of surveillance systems. Includes motion detectors, simple/complex alarm systems, video/camera equipment, amplified sound systems, miniature listening devices (bugs, telephone tapping), recording methods, and some optical enhancement systems (specifically as they relate to camera lenses). Requires: Electronics (basic) or electrical engineering. Photography skills, prowl, and investigative skills may also be useful, but not required. Base Skill: 40% + 5% per level of experience.\n\nTailing, or following someone without their knowledge, is another form of surveillance. This also includes stake-out procedures. A failed surveillance roll indicates that the tail was spotted and the subject is aware of being observed/followed. A failed roll in the use of equipment indicates a ruined or garbled recording/film (not usable) or malfunction. Bugging equipment can be easily located or noticed during the course of casual activity if a character fails his surveillance roll while planting it.",
        category: "COMMUNICATIONS",
        basePercentage: 40,
        levelBonus: 5,
        requiredSkills: ["Electronics (Basic)", "Electrical Engineering"] //TODO: This is an OR, not an AND
    },
    {
        name: "T.V./Video",
    ...
    //PILOT 
    {
      ...
      },
      {
        ...
        description: "Identical to standard mecha piloting but applies to Soviet Battloids only. Base Skill: 55% +5% per level of experience.",
        category: "PILOT",
        baseSkill: 55,
        levelBonus: 5,
        requiredSkills: [],
      ...
      {
        name: "Mecha Combat",
        description: "Specific combat training for each mecha type, essential for peak combat effectiveness.",
        category: "PILOT",
        baseSkill: null,
        levelBonus: null,
        requiredSkills: [],
      ...
      },
      {
        ...
        description: "Specialized skill for using these items with Southern Cross body armor. Base Skill: 45% +5% per level of experience.",
        category: "PILOT",
        baseSkill: 45,
        levelBonus: 5,
        requiredSkills: [],
